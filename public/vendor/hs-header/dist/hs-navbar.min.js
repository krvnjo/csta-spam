!(function (e, t) {
  ...
  return (
    (d = {
      "./src/js/hs-navbar.js": function (module, __webpack_exports__, __webpack_require__) {
        "use strict";
        eval(
    ...
    (f.t = function (t, e) {
      ...
      if ((f.r(n), Object.defineProperty(n, "default", { enumerable: !0, value: t }), 2 & e && "string" != typeof t))
        for (var s in t)
          f.d(
            n,
            s,
    ...
    (f.p = ""),
    f((f.s = "./src/js/hs-navbar.js")).default
  );
  function f(t) {
