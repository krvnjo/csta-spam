          ...
          <div class="col-lg-4">
            ...
            <div class="card-body bg-light h-100">
              <div class="d-flex align-items-center">
                ...
                <img class="avatar avatar-xl avatar-4x3" data-hs-theme-appearance="default"
                  src="{{ Vite::asset('resources/svg/illustrations/oc-review.svg') }}" alt="Image Description">
                <img class="avatar avatar-xl avatar-4x3" data-hs-theme-appearance="dark"
                  src="{{ Vite::asset('resources/svg/illustrations-light/oc-review.svg') }}" alt="Image Description">
              </div>
                          ...
                          <ul class="list-inline fs-6">
                            <li class="list-inline-item">
                              ...
                              <div class="d-flex gap-1 me-2">
                                <img src="{{ Vite::asset('resources/svg/illustrations/star.svg') }}" alt="Review rating" width="12">
                                <img src="{{ Vite::asset('resources/svg/illustrations/star.svg') }}" alt="Review rating" width="12">
                                <img src="{{ Vite::asset('resources/svg/illustrations/star.svg') }}" alt="Review rating" width="12">
                                <img src="{{ Vite::asset('resources/svg/illustrations/star.svg') }}" alt="Review rating" width="12">
                                <img src="{{ Vite::asset('resources/svg/illustrations/star.svg') }}" alt="Review rating" width="12">
                ...
                <li class="list-comment-item">
                  ...
                  <blockquote class="blockquote blockquote-sm mt-4">
                    ...
                    <div class="d-flex">
                      <div class="flex-shrink-0">
                        <div class="avatar avatar-sm avatar-circle mb-2">
                          <img class="avatar-img" src="{{ Vite::asset('resources/svg/brands/htmlstream.svg') }}" alt="Image Description">
                        </div>
                      </div>
