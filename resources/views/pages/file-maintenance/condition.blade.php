...
@section('main-content')
  <main class="main" id="content" role="main">
    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-end">
          <div class="col-sm mb-2 mb-sm-0">
            ...
            <h1 class="page-header-title mt-2">Conditions</h1>
          </div>

          <div class="col-sm-auto mt-sm-0 mt-3">
            <div class="d-grid gap-2 d-sm-flex justify-content-sm-end">
              <button class="btn btn-primary w-100 w-sm-auto" data-bs-toggle="modal" data-bs-target="#modalAddCondition">
                <i class="bi-plus me-1"></i> Add Condition
              </button>
            </div>
          </div>
        </div>
              ...
              <div class="row">
                <div class="col-12 col-md">
                  ...
                  <span class="badge bg-soft-primary text-primary rounded-pill p-1">
                    ...
                    @elseif ($deletedConditions == 1)
                      <i class="bi-arrow-counterclockwise"></i>{{ $deletedConditions }} record can be restored from bin.
                    @else
                      <i class="bi-arrow-counterclockwise"></i>{{ $deletedConditions }} records can be restored from bin.
                    @endif
                  </span>
                </div>
      ...
      <!-- End Active and Inactive Conditions Card -->
        ...
        <div class="card-header card-header-content-md-between">
          <div class="mb-2 mb-md-0">
            ...
            <div class="input-group input-group-merge input-group-flush">
              ...
              <input class="form-control" id="conditionsDatatableSearch" type="search" placeholder="Search">
            </div>
          ...
          <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
            <!-- Datatable Counter -->
            <div id="conditionsDatatableCounterInfo" style="display: none;">
              <div class="d-flex align-items-center">
                <span class="fs-5 me-3"><span id="conditionsDatatableCounter"></span> Selected</span>
                <button class="btn btn-outline-danger btn-sm" id="btnMultiDeleteCondition" type="button"><i class="bi-trash3-fill"></i>
                  Delete</button>
              </div>
            </div>
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-sm-end dropdown-card card-dropdown-filter-centered" aria-labelledby="conditionFilterDropdown"
        ...
        <div class="table-responsive datatable-custom">
          <table class="table table-lg table-borderless table-thead-bordered table-hover table-nowrap table-align-middle card-table w-100"
            ...
            data-hs-datatables-options='{
              ...
              "order": [4, "desc"],
              "info": {
                "totalQty": "#conditionsDatatableWithPagination"
              },
              "search": "#conditionsDatatableSearch",
              "entries": "#conditionsDatatableEntries",
              "pageLength": 5,
              "isResponsive": false,
              "isShowPaging": false,
              "pagination": "conditionsDatatablePagination"
            }'>
            <thead class="thead-light">
              <tr>
                <th class="table-column-pe-0 w-auto">
                  <div class="form-check">
                    <input class="form-check-input" id="conditionsDatatableCheckAll" type="checkbox">
                    <label class="form-check-label" for="conditionsDatatableCheckAll"></label>
                  </div>
                </th>
                <th class="d-none w-auto">Condition Id</th>
                <th class="w-auto">Condition Name</th>
              ...
              @foreach ($conditions as $index => $condition)
                <tr>
                  <td class="table-column-pe-0">
                    <div class="form-check">
                      <input class="form-check-input" id="conditionCheck{{ $index + 1 }}" type="checkbox">
                      <label class="form-check-label" for="conditionCheck{{ $index + 1 }}"></label>
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="btn-group" role="group">
                      <button class="btn btn-white btn-sm btnViewCondition" type="button">
                      ...
                      <div class="btn-group">
                        ...
                        <div class="dropdown-menu dropdown-menu-end mt-1" aria-labelledby="conditionActionDropdown">
                          ...
                          @if ($condition->is_active)
                            <button class="dropdown-item btnStatusCondition" data-status="0" type="button">
                              <i class="bi-x-circle-fill dropdown-item-icon text-danger fs-7"></i> Set to Inactive
                            </button>
                          @else
                            <button class="dropdown-item btnStatusCondition" data-status="1" type="button">
                              <i class="bi-check-circle-fill dropdown-item-icon text-success"></i> Set to Active
                            </button>
                          @endif
                          <div class="dropdown-divider"></div>
                          <button class="dropdown-item text-danger btnDeleteCondition" type="button">
          ...
          <div class="row justify-content-center justify-content-sm-between align-items-sm-center">
            <div class="col-sm mb-2 mb-sm-0">
              <div class="d-flex justify-content-center justify-content-sm-start align-items-center">
                ...
                <div class="tom-select-custom tom-page-w">
                  <select class="js-select form-select form-select-borderless" id="conditionsDatatableEntries"
                    data-hs-tom-select-options='{
                    ...
                    <option value="{{ $totalConditions }}">All</option>
                  </select>
                </div>

                <span class="text-secondary me-2">of</span>
                <span id="conditionsDatatableWithPagination"></span>
            ...
            <div class="col-sm-auto">
              <div class="d-flex justify-content-center justify-content-sm-end">
                <nav id="conditionsDatatablePagination" aria-label="Activity pagination"></nav>
              </div>
            </div>
          </div>
        </div>
...
@section('scripts')
  ...
  <!-- JS Modules -->
  <script src="{{ Vite::asset('resources/js/modules/file-maintenance/condition-crud.js') }}"></script>
  ...
  <script>
    ...
    $(document).on("ready", function() {
      HSCore.components.HSDatatables.init($("#conditionsDatatable"), {
        dom: "Bfrtip",
        buttons: [{
            extend: "copy",
            className: "d-none"
        ...
        select: {
          ...
          classMap: {
            checkAll: "#conditionsDatatableCheckAll",
            counter: "#conditionsDatatableCounter",
            counterInfo: "#conditionsDatatableCounterInfo"
          }
        },
        language: {
      ...
      $(".js-datatable-filter").on("change", function() {
        ...
        updateFilterCountBadge($("#conditionFilterCount"));
      });
    });
