                ...
                <div class="col-12 col-md">
                  ...
                  <span class="badge bg-soft-primary text-primary rounded-pill p-1">
                    ...
                    @elseif($inactiveAcquisitions == 1)
                      <i class="bi-arrow-clockwise"></i> 1 record can be set to active
                    @else
                      <i class="bi-arrow-clockwise"></i> {{ $inactiveAcquisitions }} records can be set to active
                    @endif
                  </span>
                </div>
                <!-- End Col -->
            ...
            <tbody>
              @foreach ($acquisitions as $acquisition)
                <tr>
                  ...
                  <td class="d-none" data-acquisition-id="{{ $acquisition->id }}"></td>
