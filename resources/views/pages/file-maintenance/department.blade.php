      ...
      <div class="card">
        ...
        <div class="card-header card-header-content-md-between">
          ...
          <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
            ...
            <!-- Dropdown -->
            <div class="dropdown">
              <button class="btn btn-white btn-sm w-100" id="departmentsFilterDropdown" data-bs-toggle="dropdown" type="button"
                aria-expanded="false">
                <i class="bi-filter me-1"></i> Filter <span class="badge bg-soft-dark text-dark rounded-circle ms-1" id="filterCountBadge"></span>
              </button>

              <div class="dropdown-menu dropdown-menu-sm-end dropdown-card card-dropdown-filter-centered" aria-labelledby="departmentsFilterDropdown"
          ...
          <table class="table table-lg table-borderless table-thead-bordered table-hover table-nowrap table-align-middle card-table"
            ...
            <thead class="thead-light">
              <tr>
                ...
                <th style="width: 25%;">Departments Name</th>
