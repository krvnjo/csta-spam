              ...
              <div class="row">
                <div class="col-12 col-md">
                  ...
                  <span class="badge bg-soft-primary text-primary rounded-pill p-1">
                    ...
                    @elseif($inactiveStatuses == 1)
                      <i class="bi-arrow-clockwise"></i> 1 record can be restored
                    @else
                      <i class="bi-arrow-clockwise"></i> {{ $inactiveStatuses }} records can be restored
                    @endif
                  </span>
                </div>
                <!-- End Col -->
        ...
        <div class="card-header card-header-content-md-between">
          <div class="mb-2 mb-md-0">
            <div class="input-group input-group-merge input-group-flush">
              ...
              <input class="form-control" id="statusesDatatableSearch" type="search" aria-label="Search" placeholder="Search">
            </div>
          </div>
          ...
          <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
            ...
            <div id="statusesDatatableCounterInfo" style="display: none;">
              <div class="d-flex align-items-center">
                <span class="fs-5 me-3">
                  <span id="statusesDatatableCounter">0</span>
                  Selected
                </span>
            ...
            <!-- Dropdown -->
            <div class="dropdown">
              <button class="btn btn-white btn-sm dropdown-toggle w-100" id="statusesExportDropdown" data-bs-toggle="dropdown" type="button"
                aria-expanded="false">
                <i class="bi-download me-2"></i> Export
              </button>

              <div class="dropdown-menu dropdown-menu-sm-end" aria-labelledby="statusesExportDropdown">
            ...
            <!-- Dropdown -->
            <div class="dropdown">
              <button class="btn btn-white btn-sm w-100" id="statusesFilterDropdown" data-bs-toggle="dropdown" type="button"
                aria-expanded="false">
                <i class="bi-filter me-1"></i> Filter <span class="badge bg-soft-dark text-dark rounded-circle ms-1" id="filterCountBadge"></span>
              </button>

              <div class="dropdown-menu dropdown-menu-sm-end dropdown-card card-dropdown-filter-centered" aria-labelledby="statusesFilterDropdown"
              ...
              <tr>
                <th class="table-column-pe-0">
                  <div class="form-check">
                    <input class="form-check-input" id="statusesDatatableCheckAll" type="checkbox" value="">
                    <label class="form-check-label" for="statusesDatatableCheckAll"></label>
                  </div>
                </th>
                <th style="width: 15%">Status Name</th>
                <th>Description</th>
              ...
              @foreach ($statuses as $status)
                <tr>
                  <td class="table-column-pe-0">
                    <div class="form-check">
                      <input class="form-check-input" id="statusesCheck" type="checkbox" value="">
                      <label class="form-check-label" for="statusesCheck"></label>
                    </div>
                  </td>
                  <td><span class="d-block h5 mb-0">{{ $status->name }}</span></td>
                  <td>{{ $status->description }}</td>
                  <td><i class="bi-calendar-event me-1"></i> {{ $status->created_at->format('M d, Y') }}</td>
                  <td>
                    @if ($status->is_active)
                  ...
                  <td>
                    <div class="dropdown position-static">
                      <button class="btn btn-white btn-sm" id="statusesDropdownActions" data-bs-toggle="dropdown" type="button"
                        aria-expanded="false">
                        More <i class="bi-chevron-down ms-1"></i>
                      </button>

                      <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end" aria-labelledby="statusesDropdownActions">
