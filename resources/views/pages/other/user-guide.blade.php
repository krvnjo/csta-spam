  ...
  <main class="main" id="content">
    ...
    <div class="container-lg">
      <div class="bg-light content-space-2 rounded-3 px-5">
        <div class="w-md-70 text-center mx-md-auto">
          <div class="mb-4">
            <img class="img-fluid mx-auto" data-hs-theme-appearance="default" src="{{ Vite::asset('resources/svg/illustrations/oc-review.svg') }}" alt="Image Description"
              style="max-width: 10rem;">
            <img class="img-fluid mx-auto" data-hs-theme-appearance="dark" src="{{ Vite::asset('resources/svg/illustrations-light/oc-review.svg') }}" alt="Image Description"
              style="max-width: 10rem;">
          </div>

          <p class="fs-2 text-dark mb-4"><em>This is a perfect theme for a modern web application. <span class="text-highlight-warning">There was clearly a lot of thought that went into
                designing</span> all of the components to look coherent and work well together in various grid layouts.</em></p>
      ...
      <div class="row">
        <div class="col-md-7 mb-4">
          ...
          <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
            ...
            <div class="card-footer border-0 pt-0 mb-n4 me-n6">
              <img class="img-fluid" data-hs-theme-appearance="default" src="{{ Vite::asset('resources/img/others/img4.png') }}" alt="Image Description">
              <img class="img-fluid" data-hs-theme-appearance="dark" src="{{ Vite::asset('resources/img/others/img4-dark.png') }}" alt="Image Description">
            </div>
          </div>
          <!-- End Card -->
        </div>
        ...
        <div class="col-md-5 mb-4">
          ...
          <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
            ...
            <div class="card-footer border-0 pt-0 mb-n4 me-n6">
              <img class="img-fluid" data-hs-theme-appearance="default" src="{{ Vite::asset('resources/img/others/img3.png') }}" alt="Image Description">
              <img class="img-fluid" data-hs-theme-appearance="dark" src="{{ Vite::asset('resources/img/others/img3-dark.png') }}" alt="Image Description">
            </div>
          </div>
          <!-- End Card -->
        </div>
        ...
        <div class="col-md-5 mb-4">
          ...
          <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
            ...
            <div class="card-footer border-0 pt-0 mb-n4 me-n6">
              <img class="img-fluid" data-hs-theme-appearance="default" src="{{ Vite::asset('resources/img/others/img6.png') }}" alt="Image Description">
              <img class="img-fluid" data-hs-theme-appearance="dark" src="{{ Vite::asset('resources/img/others/img6-dark.png') }}" alt="Image Description">
            </div>
          </div>
          <!-- End Card -->
        </div>
        ...
        <div class="col-md-7 mb-4">
          ...
          <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
            ...
            <div class="card-footer border-0 pt-0 mb-n4 me-n6">
              <img class="img-fluid" data-hs-theme-appearance="default" src="{{ Vite::asset('resources/img/others/img5.png') }}" alt="Image Description">
              <img class="img-fluid" data-hs-theme-appearance="dark" src="{{ Vite::asset('resources/img/others/img5-dark.png') }}" alt="Image Description">
            </div>
          </div>
          <!-- End Card -->
        </div>
        ...
        <div class="col-md-7 mb-4 mb-md-0">
          ...
          <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
            <div class="card-body">
              ...
              <p class="card-text lead">Upload images, videos or any files, copy to clipboard, toggle passwords, search, add fields, count characters and discover more customizable and feature-rich
                plugins.</p>
            </div>
            <div class="card-footer border-0 pt-0 mb-n4 me-n6">
              <img class="img-fluid" data-hs-theme-appearance="default" src="{{ Vite::asset('resources/img/others/img8.png') }}" alt="Image Description">
              <img class="img-fluid" data-hs-theme-appearance="dark" src="{{ Vite::asset('resources/img/others/img8-dark.png') }}" alt="Image Description">
            </div>
          </div>
          <!-- End Card -->
        </div>
        ...
        <div class="col-md-5">
          ...
          <div class="card card-lg h-100 bg-light border-0 shadow-none overflow-hidden">
            ...
            <div class="card-footer border-0 pt-0 mb-n4 me-n6">
              <img class="img-fluid" data-hs-theme-appearance="default" src="{{ Vite::asset('resources/img/others/img7.png') }}" alt="Image Description">
              <img class="img-fluid" data-hs-theme-appearance="dark" src="{{ Vite::asset('resources/img/others/img7-dark.png') }}" alt="Image Description">
            </div>
          </div>
          <!-- End Card -->
        </div>
    ...
    <div class="container-lg">
      <div class="bg-light content-space-2 rounded-3 px-5">
        <div class="w-md-70 text-center mx-md-auto">
          ...
          <p class="fs-2 text-dark mb-4"><em>The theme has a very professional look, bringing a more modern and clean style to the application. <span class="text-highlight-warning">The
                documentation is extraordinarily rich and complete</span>, helping implementation.</em></p>
      ...
      <div class="row align-items-md-center content-space-b-1 content-space-b-lg-2">
        ...
        <div class="col-md-6">
          <div class="pe-md-7">
            ...
            <a class="btn btn-primary" href="./apps-kanban.html" target="_blank">Preview Kanban <i class="bi-box-arrow-up-right ms-2"></i></a>
          </div>
        </div>
        <!-- End Col -->
      </div>
      ...
      <div class="row align-items-md-center content-space-1 content-space-b-lg-2">
        ...
        <div class="col-md-6">
          <div class="pe-md-7">
            ...
            <a class="btn btn-primary" href="./apps-calendar.html" target="_blank">Preview Calendar <i class="bi-box-arrow-up-right ms-2"></i></a>
          </div>
        </div>
        <!-- End Col -->
      </div>
      ...
      <div class="row align-items-md-center content-space-1 content-space-b-lg-2">
        ...
        <div class="col-md-6">
          <div class="pe-md-7">
            ...
            <a class="btn btn-primary" href="./apps-invoice-generator.html" target="_blank">Preview Invoice Generator <i class="bi-box-arrow-up-right ms-2"></i></a>
          </div>
        </div>
        <!-- End Col -->
      </div>
      ...
      <div class="row align-items-md-center content-space-t-1">
        <div class="col-md-6 order-md-2 mb-10 mb-md-0">
          ...
          <figure class="device-browser">
            ...
            <div class="device-browser-frame">
              <img class="img-fluid shadow-lg" data-hs-theme-appearance="default" src="{{ Vite::asset('resources/img/900x562/img10.jpg') }}" alt="Image Description">
              <img class="img-fluid shadow-lg" data-hs-theme-appearance="dark" src="{{ Vite::asset('resources/img/900x562/img10-dark.jpg') }}" alt="Image Description">
            </div>
        ...
        <div class="col-md-6">
          <div class="pe-md-7">
            ...
            <a class="btn btn-primary" href="./apps-file-manager.html" target="_blank">Preview File Manager <i class="bi-box-arrow-up-right ms-2"></i></a>
          </div>
        </div>
        <!-- End Col -->
      </div>
    ...
    <div class="container-lg">
      <div class="bg-dark position-relative rounded overflow-hidden pt-4 px-4 pt-sm-10 px-sm-10">
        ...
        <img class="img-fluid" data-hs-theme-appearance="default" src="{{ Vite::asset('resources/svg/illustrations/docs-main-page.svg') }}" alt="Image Description">
        <img class="img-fluid" data-hs-theme-appearance="dark" src="{{ Vite::asset('resources/svg/illustrations/docs-main-page-dark.svg') }}" alt="Image Description">
    ...
    <div class="container-lg content-space-2 content-space-lg-3">
      ...
      <div class="w-md-75 w-lg-50 mx-md-auto mb-5 mb-md-9">
        ...
        <div class="text-center mb-7">
          <p>Not comfortable diving that deep? No worries, you just use the compiled CSS and examples pages! <a class="link" href="./documentation/gulp.html">Learn more <i
                class="bi-chevron-right small"></i></a></p>
        </div>

        <div class="row justify-content-center">
          <div class="col-auto col-sm-3 col-sm py-3">
            <img class="avatar avatar-xl avatar-4x3" src="{{ Vite::asset('resources/svg/brands/bootstrap-gray.svg') }}" alt="Logo">
          </div>
          <!-- End Col -->

          <div class="col-auto col-sm-3 col-sm py-3">
            <img class="avatar avatar-xl avatar-4x3" src="{{ Vite::asset('resources/svg/brands/sass-gray.svg') }}" alt="Logo">
          </div>
          <!-- End Col -->

          <div class="col-auto col-sm-3 col-sm py-3">
            <img class="avatar avatar-xl avatar-4x3" src="{{ Vite::asset('resources/svg/brands/gulp-gray.svg') }}" alt="Logo">
          </div>
          <!-- End Col -->

          <div class="col-auto col-sm-3 col-sm py-3">
            <img class="avatar avatar-xl avatar-4x3" src="{{ Vite::asset('resources/svg/brands/npm-gray.svg') }}" alt="Logo">
          </div>
          <!-- End Col -->
        </div>
        <!-- End Row -->
    ...
    <div class="container-lg">
      <div class="bg-light content-space-2 rounded-3 px-5">
        <div class="w-md-70 text-center mx-md-auto">
          ...
          <p class="fs-2 text-dark mb-4"><em>This theme is really great, as back end developer <span class="text-highlight-warning">I was able to build an impressive front end using this theme in
                plain JavaScript vanilla. The source code is clear and the documentation as well, for me it's the best purchase I made with this team and I am watching evolution.</span> Thank you so
              much for such quality and price. Keep going!</em></p>
        ...
        <div class="w-md-75 mx-md-auto">
          <div class="position-relative">
            ...
            <div class="d-none d-md-block position-absolute bottom-0 start-0">
              <img class="img-fluid" data-hs-theme-appearance="default" src="{{ Vite::asset('resources/svg/illustrations/oc-peeking.svg') }}" alt="Image Description"
                style="max-width: 8rem; margin-left: -7.8125rem;">
              <img class="img-fluid" data-hs-theme-appearance="dark" src="{{ Vite::asset('resources/svg/illustrations-light/oc-peeking.svg') }}" alt="Image Description"
                style="max-width: 8rem; margin-left: -7.8125rem;">
            </div>

            <div class="d-none d-md-block position-absolute top-50 end-0 translate-middle-y">
              <img class="img-fluid" data-hs-theme-appearance="default" src="{{ Vite::asset('resources/svg/illustrations/oc-on-the-go.svg') }}" alt="Image Description"
                style="max-width: 15rem; margin-right: -15rem;">
              <img class="img-fluid" data-hs-theme-appearance="dark" src="{{ Vite::asset('resources/svg/illustrations-light/oc-on-the-go.svg') }}" alt="Image Description"
                style="max-width: 15rem; margin-right: -15rem;">
            </div>
          </div>
        </div>
