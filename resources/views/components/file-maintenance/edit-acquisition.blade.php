...
<div class="modal fade" id="editAcquisitionModal" data-bs-backdrop="static" role="dialog"
  aria-labelledby="editAcquisitionModalLabel" aria-hidden="true" tabindex="-1">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmEditAcquisition" method="post" novalidate>
          ...
          <label class="col col-form-label form-label" for="txtEditAcquisition">Acquisition Name <span
              class="text-danger">*</span></label>
          <input class="form-control" id="txtEditAcquisition" name="acquisition" type="text"
