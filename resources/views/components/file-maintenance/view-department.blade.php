...
<div class="modal fade" id="modalViewDepartment" role="dialog" tabindex="-1">
      ...
      <div class="modal-body">
        <div class="col">
          ...
          <div class="row mb-3">
            ...
            <div class="col-7 d-flex align-items-center">
              <p class="mb-0" id="lblViewDeptCode"></p>
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-7 d-flex align-items-center">
              <div class="btn-group w-100">
                <button class="btn btn-sm btn-white dropdown-toggle" id="lblViewTotalDesignations" data-bs-toggle="dropdown" type="button"
                  aria-expanded="false"></button>
                <div class="dropdown-menu w-100 scrollable-dropdown-menu" id="designationsDropdownMenu"></div>
              </div>
            </div>
          </div>
