<!-- View Status Modal -->
<div class="modal fade" id="modalViewStatus" role="dialog" tabindex="-1">
        ...
        <div class="col">
          <div class="row mb-4">
            <div class="col-5 d-flex align-items-center">
              <p class="form-label fw-semibold mb-0">Status Name:</p>
            </div>
            <div class="col-7 d-flex align-items-center">
              <span id="lblViewStatusName"></span>
            </div>
          </div>
          ...
          <div class="row mb-4">
            ...
            <div class="col-7 d-flex align-items-center">
              <p class="mb-0 description-long-text" id="lblViewDescription"></p>
            </div>
          </div>
