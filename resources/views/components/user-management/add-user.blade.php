<!-- Add User Modal -->
<div class="modal fade" id="addUserModal" data-bs-backdrop="static" role="dialog" aria-labelledby="addUserModalLabel"
        ...
        <form id="frmAddUser" method="post" enctype="multipart/form-data" novalidate>
          ...
          <div class="profile-cover">
            <div class="profile-cover-img-wrapper">
              <img class="profile-cover-img" src="{{ Vite::asset('resources/img/1920x400/img2.jpg') }}"
                alt="Profile Cover">
          ...
          <label class="avatar avatar-xxl avatar-circle avatar-uploader profile-cover-avatar mb-5" for="imgAddImage">
            <img class="avatar-img" id="imgDisplayUserImage"
              src="{{ Vite::asset('resources/img/uploads/user-images/default.jpg') }}" alt="Image Description">
          ...
          <div class="row mb-4">
            ...
            <div class="col-sm-9">
              <input class="form-control" id="txtAddUserFname" name="fname" type="text"
          ...
          <div class="row mb-4">
            ...
            <div class="col-sm-9">
              <input class="form-control" id="txtAddUserMname" name="mname" type="text"
          ...
          <div class="row mb-4">
            ...
            <div class="col-sm-9">
              <input class="form-control" id="txtAddUserLname" name="lname" type="text"
          ...
          <div class="row mb-4">
            ...
            <div class="col-sm-9">
              <input class="form-control" id="txtAddUserEmail" name="email" type="email"
          ...
          <div class="row mb-4">
            ...
            <div class="col-sm-9">
              <div class="input-group">
                ...
                <a class="input-group-text" id="togglePassConTarget"><i class="bi-eye"
                    id="toggleConPassIcon"></i></a>
        ...
        <div class="row align-items-sm-center flex-grow-1 mx-n2">
          ...
          <div class="col-sm-auto">
            <div class="d-flex gap-2">
              ...
              <button class="btn btn-primary" form="frmAddUser" type="submit">Save</button>
            </div>
          </div>
        </div>
      </div>
